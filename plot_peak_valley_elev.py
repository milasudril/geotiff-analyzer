...
def load(filename):
	...
	return DataSeries(os.path.basename(filename).split('.')[0], peak[0], [data[1], data[1] - data[0]])
...
if __name__ == '__main__':
	...
	plt.sca(ax)
	plt.xlabel('Peak elevation / m')
	plt.ylabel('Tallness / m')
